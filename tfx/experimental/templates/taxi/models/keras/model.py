...
def _build_keras_model(hidden_units=None):
  ...
  model = _wide_and_deep_classifier(
      # For template dev:TODO(b/140320729) Replace with premade wide_and_deep
      #                                    keras model
...
def _wide_and_deep_classifier(wide_columns, deep_columns, dnn_hidden_units):
  ...
  # For template dev:TODO(b/139081439): Automate generation of input layers from
  #                                     FeatureColumn.
  ...
  # For template dev: TODO(b/144500510): SparseFeatures for feature columns +
  #                                      Keras.
...
def run_fn(fn_args):
  ...
  model = _build_keras_model(hidden_units=hparams.HIDDEN_UNITS)
